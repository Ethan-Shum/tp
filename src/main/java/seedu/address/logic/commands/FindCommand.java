...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all applications whose company names, roles, "
            ...
            + "Parameters: [n/COMPANY_NAME] [r/ROLE] [d/APPLICATION_DATE] or [d/START_DATE:END_DATE] [u/URL] [s/STATUS]...\n"
            + "Example: " + COMMAND_WORD + " n/Google r/Intern d/2022-12-12:2022-12-15 u/https://www.google.com/ s/Applied";

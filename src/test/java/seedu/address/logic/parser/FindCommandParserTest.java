...
public class FindCommandParserTest {
    ...
    public void parse_validArgs_returnsFindCommand() {
        FindCommand expectedFindCommand = new FindCommand(new ApplicationContainsKeywordsPredicate(
                Arrays.asList("Google", "Meta"), new ArrayList<>(), null, null, new ArrayList<>(), new ArrayList<>()));
        ...
        expectedFindCommand = new FindCommand(new ApplicationContainsKeywordsPredicate(
                new ArrayList<>(), Arrays.asList("Intern", "Developer"), null, null, new ArrayList<>(), new ArrayList<>()));
        ...
        expectedFindCommand = new FindCommand(new ApplicationContainsKeywordsPredicate(
                new ArrayList<>(), new ArrayList<>(), null, null, Arrays.asList("careers.google.com"), new ArrayList<>()));
    ...
    public void parse_emptyKeywords_throwsParseException() {
        assertParseFailure(parser, " " + PREFIX_COMPANY + " ", String.format(MESSAGE_INVALID_COMMAND_FORMAT, FindCommand.MESSAGE_USAGE));
        assertParseFailure(parser, " " + PREFIX_ROLE + " ", String.format(MESSAGE_INVALID_COMMAND_FORMAT, FindCommand.MESSAGE_USAGE));
        assertParseFailure(parser, " " + PREFIX_URL + " ", String.format(MESSAGE_INVALID_COMMAND_FORMAT, FindCommand.MESSAGE_USAGE));
        assertParseFailure(parser, " " + PREFIX_STATUS + " ", String.format(MESSAGE_INVALID_COMMAND_FORMAT, FindCommand.MESSAGE_USAGE));
        assertParseFailure(parser, " " + PREFIX_COMPANY + "Google " + PREFIX_ROLE + " ", String.format(MESSAGE_INVALID_COMMAND_FORMAT, FindCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_invalidDate_throwsParseException() {
        assertParseFailure(parser, " " + PREFIX_APPLICATION_DATE + "2022-13-12",
                ApplicationDate.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, " " + PREFIX_APPLICATION_DATE + "2022-12-12:2022-13-12",
                ApplicationDate.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, " " + PREFIX_APPLICATION_DATE + "2022-12-15:2022-12-12",
